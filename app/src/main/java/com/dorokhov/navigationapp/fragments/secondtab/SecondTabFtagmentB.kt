 ...
 * Use the [SecondTabFtagmentB.newInstance] factory method to
 * create an instance of this fragment.
 */
class SecondTabFtagmentB : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SecondTabFtagmentB.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SecondTabFtagmentB().apply {
